...
<form action="{{url('person')}}" method="post" class="container" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="card ">
        <div class="cardbody mt-3 ml-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{url('person')}}" type="button" class="btn btn-danger col-md-5 mt-2" style='float:right;'>Cancel</a>
