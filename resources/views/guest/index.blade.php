    ...
    <div class="insideDetailTextContainer row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2">
      ...
      <div style="width: 60%;" class="detailTextContainer">
        ...
        <div class="detailButton">
          <a href="{{asset('pdfs/7_1718352422.pdf' )}}" download><button type="button" class="btn btn-orange">Download <i class="fa-solid fa-circle-down"></i></button></a>
          <a href="{{asset('pdfs/7_1718352422.pdf' )}}" target="_blank"><button type="button" class="btn btn-orange">Read Online <i class="fa-solid fa-eye"></i></button></a>
        </div>
      </div>
    </div>
  </div>
