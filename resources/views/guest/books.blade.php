...
<div class="sliderContainer">
  ...
  <div class="detailContainer mySlides">
    <div class="insideDetailTextContainer row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2">
      <div class="imageContainer" style="width: 30%;">
        <img src="../img/akt_hateu12.jpg" alt="image" width=" 352px" height="485px">
      </div>
      <div style="width: 60%;" class="detailTextContainer">
        ...
        <div class="detailButton">
          <a href="{{asset('pdfs/pdf' )}}" download><button type="button" class="btn btn-orange">Download <i class="fa-solid fa-circle-down"></i></button></a>
          <a href="{{asset('pdfs/pdf' )}}" target="_blank"><button type="button" class="btn btn-orange">Read Online <i class="fa-solid fa-eye"></i></button></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="detailContainer mySlides">
    <div class="insideDetailTextContainer row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2">
      <div class="imageContainer" style="width: 30%;">
        <img src="../img/mtt_iwishtocontinue.jpg" alt="image" width=" 352px" height="485px">
      </div>
  ...
  <div class="detailContainer mySlides">
    <div class="insideDetailTextContainer row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2">
      <div class="imageContainer" style="width: 30%;">
        <img src="../img/mtt_teashop.jpg" alt="image" width=" 352px" height="485px">
      </div>
      <div style="width: 60%;" class="detailTextContainer">
        <h5 class="detailText author">မြသန်းတင့်</h5>
  ...
  <div class="detailContainer mySlides">
    <div class="insideDetailTextContainer row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2">
      <div class="imageContainer" style="width: 30%;">
        <img src="../img/WayToTalkWithEverybody.jpg" alt="image" width=" 352px" height="485px">
      </div>
      <div style="width: 60%;" class="detailTextContainer">
  ...
  <div class="detailContainer mySlides">
    <div class="insideDetailTextContainer row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2">
      <div class="imageContainer" style="width: 30%;">
        <img src="../img/mts_yaynantharkhinkhingyi_2.jpg" alt="image" width=" 352px" height="485px">
      </div>
      <div style="width: 60%;" class="detailTextContainer">
